...
<div id="colorlib-subscribe" style="background-image: url(<?php bloginfo('template_directory');?>/assets/images/img_bg_2.jpg);" data-stellar-background-ratio="0.5">
...
<div class="msg-animation" style="display: none;z-index:999; ">
	<div class="text"><p>Sending Mail</p></div>
	<div class="ico-wrap">
	  <div class="top">
	    <div class="top1"></div>
	    <div class="top2"></div>
...
<style type="text/css">
    ...
    #myModalfailure .modal-confirm .form-control, .modal-confirm .btn {
    min-height: 40px;
    border-radius: 3px;
    }
    ...
    #myModalfailure .modal-confirm .btn:hover, .modal-confirm .btn:focus {
    background: #da2c12;
    outline: none;
    }
