...
<head>
	...
	<meta name="author" content="Incredible Tarkarli" />
					...
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo">
								...
								<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/assets/images/logo/Incredible Tarkarli Logo.png" title="" style="max-width:300px;"></a>
							</div>
						</div>
...
<div id="error-message-popup" style="display:none">
	...
	<button type="button" id="popup-close" class="close" style="top: 1px;"><span aria-hidden="true">&times;</span></button>
	<strong>Validation Error !</strong> Please check the required or invalid fields.
	</div>
</div>